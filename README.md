# 🔍 SSH Honeypot - Cybersecurity Project

A custom Python honeypot that detects and logs SSH attacks in real-time.

## 🎯 Features
- Real-time SSH attack detection on port 2222
- Automated logging of attacker IPs and methods
- Multi-threaded connection handling

## 📁 Project Files
- `my_honeypot.py` - Custom honeypot code
- `honeypot_log.txt` - Real attack data captured
...
![Sample Attacks](https://github.com/sahaana2005/ssh-honeypot-monitor/blob/main/3.png?raw=true)
